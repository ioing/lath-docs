"use strict";
(self["webpackChunklath_docs"] = self["webpackChunklath_docs"] || []).push([["Lath_app_index-fbd2f7fa_js"],{

/***/ "../Lath/app/index-fbd2f7fa.js":
/*!*************************************!*\
  !*** ../Lath/app/index-fbd2f7fa.js ***!
  \*************************************/
...
/* harmony import */ var _index_6dbce2a7_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index-6dbce2a7.js */ "../Lath/app/index-6dbce2a7.js");
const switcherStyle=`
...
`;class AppSwitcher{constructor(e){this.progressName="";var{relativeViewport:t,absoluteViewport:i,fixedViewport:s}=e.segue;this.relativeViewport=t,this.absoluteViewport=i,this.fixedViewport=s,this.application=e,this.delayDynamicImport()}bindResize(){const e=()=>{this.close(),window.removeEventListener("resize",e),window.removeEventListener("orientationchange",e)};window.addEventListener("resize",e),window.addEventListener("orientationchange",e)}open(){return (0,_index_18a99eb3_js__WEBPACK_IMPORTED_MODULE_0__._)(this,void 0,void 0,function*(){"open"!==this.progressName&&(this.progressName="open",yield this.createAppSwitcher(),this.blurBackgroundImage(),this.switcher.style.opacity="1",this.bindResize(),(0,_index_6dbce2a7_js__WEBPACK_IMPORTED_MODULE_1__.s)(()=>{"close"!==this.progressName&&(this.progressName="")},400))})}close(){"close"!==this.progressName&&(this.progressName="close",this.focusBackgroundImage(),this.switcher.style.opacity="0",(0,_index_6dbce2a7_js__WEBPACK_IMPORTED_MODULE_1__.s)(()=>{"open"!==this.progressName&&(this.progressName="",this.switcher.parentElement===this.fixedViewport&&this.fixedViewport.removeChild(this.switcher))},400))}createAppSwitcher(){return (0,_index_18a99eb3_js__WEBPACK_IMPORTED_MODULE_0__._)(this,void 0,void 0,function*(){this.switcher=document.createElement("applet-switcher"),this.switcher.style.cssText=switcherStyle,this.snapWrapper=document.createElement("applet-switcher-snap"),this.snapWrapper.style.cssText=800<this.switcher.offsetWidth?snapWrapper3Style:snapWrapper2Style,this.scroll=new _index_6dbce2a7_js__WEBPACK_IMPORTED_MODULE_1__.S(this.snapWrapper);var e=this.application.applets,t=this.getActiveApplet();for(const d in e){var i,s,r,o,a,n,p,l=e[d],c=l.color;"applet"!==l.rel||l.isModality||l.view&&(i=document.createElement("applet-switcher-item"),s=document.createElement("div"),r=document.createElement("div"),o=document.createElement("div"),a=document.createElement("div"),n=document.createElement("div"),i.style.cssText=itemViewStyle,p=l.config.poster?`
    ...
    `,yield this.stretchToItem(p),"open"!==this.progressName){const o=Date.now();this.application.to(a.id,a.param).then(()=>{var e=Date.now()-o;(0,_index_6dbce2a7_js__WEBPACK_IMPORTED_MODULE_1__.s)(()=>{this.progressName="",this.close()},200<e?0:400-e)})}})}stretchToItem(t){return (0,_index_18a99eb3_js__WEBPACK_IMPORTED_MODULE_0__._)(this,void 0,void 0,function*(){return new Promise(e=>{(0,_index_6dbce2a7_js__WEBPACK_IMPORTED_MODULE_1__.r)(()=>{"open"!==this.progressName&&(t.style.height=this.switcher.offsetHeight+"px",t.style.transform="translate3d(0px, 0px, 0px) scale(1)",t.style.borderRadius="0",this.snapWrapper.style.transition="transform .44s cubic-bezier(0.52, 0.16, 0.24, 1), opacity .2s cubic-bezier(0.52, 0.16, 0.24, 1)",this.snapWrapper.style.transform="translate3d(0, 0, 0) scale(.9)",this.snapWrapper.style.opacity="0.5",(0,_index_6dbce2a7_js__WEBPACK_IMPORTED_MODULE_1__.s)(e,200))})})})}shrinkToItem(e,o){return (0,_index_18a99eb3_js__WEBPACK_IMPORTED_MODULE_0__._)(this,void 0,void 0,function*(){const t=e.offsetHeight,i=e.offsetTop,s=e.offsetLeft;const r=e.offsetWidth/this.switcher.offsetWidth;return new Promise(e=>{(0,_index_6dbce2a7_js__WEBPACK_IMPORTED_MODULE_1__.r)(()=>{"close"!==this.progressName&&(o.style.height=t/r+"px",o.style.transform=`translate3d(${s}px, ${i}px, 0px) scale(${r})`,(0,_index_6dbce2a7_js__WEBPACK_IMPORTED_MODULE_1__.s)(e,600))})})})}getActiveApplet(){var e=this.application.activityApplet;return null!=e&&e.slide?this.application.applets[e.slide.activeId]:e}blurBackgroundImage(){this.relativeViewport.style.filter="blur(20px)",this.absoluteViewport.style.filter="blur(20px)"}focusBackgroundImage(){this.relativeViewport.style.filter="none",this.absoluteViewport.style.filter="none"}delayDynamicImport(){Promise.all(/*! import() */[__webpack_require__.e("vendors-Lath_node_modules_html2canvas_dist_html2canvas_js"), __webpack_require__.e("Lath_app_index-7b6b2dce_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./index-7b6b2dce.js */ "../Lath/app/index-7b6b2dce.js")).catch(e=>{console.warn(e)})}}

/***/ })

}]);
//# sourceMappingURL=Lath_app_index-fbd2f7fa_js.js.map